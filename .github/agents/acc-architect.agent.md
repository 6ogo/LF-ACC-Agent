...
handoffs:
  - label: Build the webapp
    agent: ACC-Webapp-Dev
    prompt: Implement the ACC webapp design above following the wiki patterns.
  - label: Build the workflow script
    agent: ACC-Workflow-Dev
    prompt: Implement the workflow script design above following the wiki patterns.
---
